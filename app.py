...
# ---------- Footer / Help ----------
st.markdown("---")
st.write("**Notes:** This dashboard expects the CSV generated by the provided Scrapy spider. If your CSV has different column names, rename them or upload the CSV in the sidebar.")
